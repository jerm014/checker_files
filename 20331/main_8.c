...
int main(void)
{
	...
	root->right->right->right->right = _binary_tree_node(root->right->right->right, 130);
	root->right->right->right->right->right = _binary_tree_node(root->right->right->right->right, 140);
